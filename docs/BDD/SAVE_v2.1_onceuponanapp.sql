...
--
-- Hôte : localhost:3306
-- Généré le : jeu. 02 nov. 2023 à 10:01
...
--
-- Structure de la table `answer_effect`
--
...
--
-- Structure de la table `event_npc`
--
...
--
-- Structure de la table `hero_class`
--
...
--
-- Structure de la table `hero_event`
--
...
--
-- Structure de la table `hero_item`
--
...
(1, 'Brom la Chasseuse  de Monstres', 'Brom lève sa main gantée vers le ciel et un éclair d\'énergie magique crépite dans sa paume. Les champignons se mettent à briller intensément. Elle se tourne vers vous avec un sourire malicieux.', 100, 100, 100, 100, 100, 100, 0, 0, 0, 1, 162, 100),
(2, 'Eloi le Protecteur des Animaux', 'D\'un pas léger malgré sa carrure imposante, Éloi s\'approche de vous, accompagné d\'une ménagerie d\'animaux. Il tend les bras et un écureuil s\'y précipite alors qu\'il s\'adresse à vous.', 100, 100, 100, 100, 100, 100, 0, 0, 0, 1, 167, 100),
(3, 'Lysandre l\'Érudite', 'Lysandre semble incarner la sagesse et la beauté des temps anciens. Elle s\'approche de vous avec grâce, ses pas résonnant doucement sur les dalles de pierre. Elle brûle de vous poser une question capitale.', 100, 100, 100, 100, 100, 100, 0, 0, 0, 2, 180, 100),
(4, 'Thorgar la Rôdeuse', 'Thorgar dégage une aura féroce et semble évaluer votre potentiel. De terribles loups aux yeux dorés l\'accompagnent. Ils se postent à ses côtés en vous observant.', 100, 100, 100, 100, 100, 100, 0, 1, 0, 1, 186, 100),
(5, 'Les Farfadets Chapardeurs', 'En baissant les yeux vous découvrez les Farfadets Chapardeurs, d\'étranges et espiègles créatures aux yeux malicieux.', 100, 100, 100, 100, 100, 100, 0, 1, 0, 8, 170, 100),
(6, 'Les Gobelins Artificiers', 'Le chef des Gobelins Artificiers se présente devant vous, redoutable inventeur déjanté, maîtrisant l\'art de la magie mécanique et de l\'alchimie déviante.', 100, 100, 100, 100, 100, 100, 0, 1, 200, 3, 171, 100),
(7, 'Le Dragon des Brumes', 'Il se dresse fièrement sur ses pattes griffues, ses ailes déployées, et pousse un hurlement déchirant qui fait vibrer vos os. Sa gueule ne crache pas du feu, mais un nuage de brume toxique.', 100, 100, 100, 100, 100, 100, 1, 1, 0, 14, 165, 100),
(8, 'La Gardienne des Ancêtres', 'Avec étonnement, vous constatez que le dernier grondement provient du ventre de la Gardienne des Ancêtres qui s\'avance vers vous.', 100, 100, 100, 100, 100, 100, 1, 1, 0, 11, 43, 100),
(9, 'La Sorcière de l\'humus', 'Elle s\'avance d\'un pas lent et majestueux, exsudant une aura de pouvoir corrompu. Son rire vous fait frissonner jusqu\'à la moelle.', 100, 100, 100, 100, 100, 100, 1, 1, 0, 7, 176, 100),
(10, 'Arachnus Maximus', 'L\'imposant Arachnus Maximus émerge des ombres, le corps couvert de poils noirs et brillants. Ses pattes se terminent en griffes acérées.', 100, 100, 100, 100, 100, 100, 0, 1, 100, 10, 160, 100),
(11, 'Elara la Prêtrese Sylvestre', 'Elara est une prêtresse douce et bienveillante, vêtue d\'une robe blanche ornée de feuilles et de fleurs. Ses yeux reflètent la sagesse des anciens esprits.', 100, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, 1, 166, 100),
(12, 'Lumi le Petit Pêcheur', 'Lumi est un garçon vif et curieux au visage constellé de taches de rousseur. Il tient une canne à pêche miniature dans ses mains.', 100, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, 1, 179, 100),
(13, 'Ivy, votre Sorcière Bien Aimée', 'La lumière provient de la main de cette petite sorcière. Elle est verte, tout comme sa peau claire et ses deux longues tresses.', 100, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, 7, 174, 100),
(14, 'Bryn, le Chevalier Feuillu', 'Bryn est une force tranquille. Son armure végétale se fond si bien dans le paysage que vous avez failli le rater.', 100, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, 5, 163, 100),
(15, 'Stella la Dryade Lunaire', 'Une jeune femme dont la pâleur n\'a d\'égale que sa beauté se tient devant vous dans la nuée d\'étoiles. Vous mettez la main en visière, comme pour mieux discerner ses traits diffus.', 100, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, 5, 185, 100),
(16, 'Pop-Cornes le Minotaure', 'Son corps massif et sa crinière touffue vous impressionnent. Il a l\'air affamé et les gargouillis de son ventre font vibrer la terre sous vos pieds.', 100, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, 16, 183, 100),
(17, 'Remy le Barde', 'Au centre du groupe, vous repérez immédiatement le barde, sa guitare acoustique à la main. Il a des cheveux magnifiques et respire la confiance et la séduction.', 100, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, 1, 184, 100),
(18, 'Farcey Atrap, un Lutin Plaisantin', 'Farcey Atrap observe les miroirs avec amusement et applaudit, ravi de son effet ! Il a les gestes vifs et agiles d\'un prestidigitateur...', 100, NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, 13, 169, 100),
(19, 'Griflamme l\'Impétueux', 'Un loup aux yeux perçants surgit des ténèbres. Son allure majestueuse dégage une aura effrayante et fascinante. Sa voix rauque résonne dans l\'air glacial.', 100, NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, 1, 173, 100),
(20, 'Gobul, Reine des Sangsues', 'Une créature à la peau visqueuse sort lentement de l\'eau. Des sangsues géantes se tortillent sur son corps. Elle vous regarde avec un sourire malsain.', 100, NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, 16, 172, 100),
(21, 'Ombrethorn, le Fantôme Sylvestre', 'Ombrethorn flotte dans les airs, son corps translucide se mêlant à la brume environnante. Autour de lui, des feux follets dansent mystérieusement.', 100, NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, 11, 182, 100),
(22, 'Discordia la Dryade', 'Le sourire malicieux et le regard pétillant de Discordia trahissent sa nature facétieuse. Autour d\'elle, les animaux de la forêt semblent se divertir en reprenant les ragots qu\'elle colporte.', 100, NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, 5, 164, 100),
(23, 'Jerarmajax, le Maître des Illusions', 'Les vêtements chatoyants du magicien reflètent la lueur astrale. Il semble capable de manipuler les étoiles elles-mêmes pour créer des mirages troublants.', 100, NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, 1, 175, 100),
(24, 'Lilith, la Voleuse d\'Écho', 'Lilith apparaît, aérienne. Ses lèvres ne bougent pas et pourtant, autour d\'elle, des ombres mélodieuses semblent déverser des mots volés que vous peinez à comprendre.', 100, NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, 11, 178, 100),
(25, 'Le Petit Chaperon Rouge-Sang', 'Elle est vêtue d\'une cape écarlate et son visage est dissimulé par le capuchon, dévoilant uniquement son regard surnaturel. Sa démarche est à la fois gracieuse et dérangeante, comme si la Grande Faucheuse elle-même avait pris forme dans ce personnage envoûtant. Ses doigts crochus se crispent sur l\'anse de son panier macabre.', 100, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, 11, 177, 100),
(26, 'Maître Corbeau', 'Soudain, un craquement retentit et le Maître Corbeau se révèle, son regard trahissant une intelligence maligne. Sa voix s\'élève, teintée d\'une ironie mordante, alors qu\'il se prépare à défendre son royaume de votre dérangeante présence.', 100, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, 10, 181, 100),
(27, 'Aria la Biche Blessée', 'La Biche Blessée avance vers vous en quelques bonds étranges, sa silhouette déformée par la souffrance et la rage. Ses yeux autrefois doux sont maintenant injectés de sang, et ses bois déchiquetés semblent prêts à transpercer quiconque ose s\'approcher. Des cicatrices béantes marquent son pelage délavé.', 100, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, 10, 161, 100);

-- --------------------------------------------------------

--
-- Structure de la table `npc_item`
--
