...
CREATE TABLE `hero` (
  ...
  `played_event` longtext COLLATE utf8mb4_unicode_ci COMMENT '(DC2Type:array)',
  PRIMARY KEY (`id`),
...
(2,	'Epée rudimentaire',	NULL,	1,	NULL,	NULL,	NULL,	NULL,	NULL,	190),
(3,	'Bouclier rudimentaire',	NULL,	NULL,	NULL,	NULL,	1,	NULL,	NULL,	192),
(4,	'Petite potion',	60,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	193),
(5,	'Dague rudimentaire',	NULL,	NULL,	NULL,	1,	NULL,	NULL,	NULL,	191),
(6,	'Rune simple',	NULL,	NULL,	1,	NULL,	NULL,	NULL,	NULL,	194);
