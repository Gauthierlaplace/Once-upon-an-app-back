...
('DoctrineMigrations\\Version20230608114918',	'2023-12-07 17:15:32',	55),
('DoctrineMigrations\\Version20230608114924',	'2023-12-07 17:15:32',	24),
('DoctrineMigrations\\Version20230608115345',	'2023-12-07 17:15:32',	29),
('DoctrineMigrations\\Version20230608115548',	'2023-12-07 17:15:32',	17),
('DoctrineMigrations\\Version20230608115914',	'2023-12-07 17:15:32',	20),
('DoctrineMigrations\\Version20230608115925',	'2023-12-07 17:15:32',	14),
('DoctrineMigrations\\Version20230608120055',	'2023-12-07 17:15:32',	14),
('DoctrineMigrations\\Version20230608120155',	'2023-12-07 17:15:32',	13),
('DoctrineMigrations\\Version20230608120205',	'2023-12-07 17:15:32',	17),
('DoctrineMigrations\\Version20230608120242',	'2023-12-07 17:15:32',	14),
('DoctrineMigrations\\Version20230608120611',	'2023-12-07 17:15:32',	13),
('DoctrineMigrations\\Version20230608120627',	'2023-12-07 17:15:32',	15),
('DoctrineMigrations\\Version20230608121709',	'2023-12-07 17:15:32',	14),
('DoctrineMigrations\\Version20230608121712',	'2023-12-07 17:15:32',	13),
('DoctrineMigrations\\Version20230608130332',	'2023-12-07 17:15:32',	21),
('DoctrineMigrations\\Version20230608130559',	'2023-12-07 17:15:32',	18),
('DoctrineMigrations\\Version20230608132036',	'2023-12-07 17:15:32',	80),
('DoctrineMigrations\\Version20230608132442',	'2023-12-07 17:15:32',	140),
('DoctrineMigrations\\Version20230608132738',	'2023-12-07 17:15:32',	140),
('DoctrineMigrations\\Version20230608132949',	'2023-12-07 17:15:33',	151),
('DoctrineMigrations\\Version20230608133053',	'2023-12-07 17:15:33',	81),
('DoctrineMigrations\\Version20230608133225',	'2023-12-07 17:15:33',	85),
('DoctrineMigrations\\Version20230608133331',	'2023-12-07 17:15:33',	80),
('DoctrineMigrations\\Version20230608133955',	'2023-12-07 17:15:33',	105),
('DoctrineMigrations\\Version20230608134212',	'2023-12-07 17:15:33',	108),
('DoctrineMigrations\\Version20230608134310',	'2023-12-07 17:15:33',	101),
('DoctrineMigrations\\Version20230608134406',	'2023-12-07 17:15:33',	99),
('DoctrineMigrations\\Version20230608134447',	'2023-12-07 17:15:33',	102),
('DoctrineMigrations\\Version20230613092007',	'2023-12-07 17:15:33',	18),
('DoctrineMigrations\\Version20230619114003',	'2023-12-07 17:15:33',	36),
('DoctrineMigrations\\Version20230622133928',	'2023-12-07 17:15:34',	36),
('DoctrineMigrations\\Version20230626212201',	'2023-12-07 17:15:34',	13),
('DoctrineMigrations\\Version20230626214201',	'2023-12-07 17:15:34',	368),
('DoctrineMigrations\\Version20230626222428',	'2023-12-07 17:15:34',	32),
('DoctrineMigrations\\Version20230626231127',	'2023-12-07 17:15:34',	89),
('DoctrineMigrations\\Version20231004151032',	'2023-12-07 17:15:34',	61),
('DoctrineMigrations\\Version20231102095113',	'2023-12-07 17:15:34',	54),
('DoctrineMigrations\\Version20231102103908',	'2023-12-07 17:15:34',	109),
('DoctrineMigrations\\Version20231109124637',	'2023-12-07 17:15:34',	19),
('DoctrineMigrations\\Version20231116202700',	'2023-12-07 17:15:34',	21);
...
(206,	'Jerarmajax, le Maître des Illusions',	'Les vêtements chatoyants du magicien reflètent la lueur astrale. Il semble capable de manipuler les étoiles elles-mêmes pour créer des mirages troublants.',	20,	100,	100,	100,	99,	100,	0,	1,	NULL,	40,	7);
...
CREATE TABLE `hero` (
  ...
  `played_event` longtext DEFAULT NULL COMMENT '(DC2Type:array)',
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_51CE6E86AC6657E4` (`fight_id`),
  ...
  CONSTRAINT `FK_51CE6E86AC6657E4` FOREIGN KEY (`fight_id`) REFERENCES `fight` (`id`),
...
(12,	'Testeur',	100,	100,	100,	100,	100,	100,	7,	0,	0,	2,	27,	18,	206,	'a:1:{i:0;i:1;}'),
(13,	'Visiteur',	100,	100,	100,	100,	100,	100,	0,	0,	0,	2,	28,	11,	NULL,	NULL),
(14,	'Death',	1,	1,	100,	100,	100,	100,	4,	0,	0,	3,	29,	25,	NULL,	'N;'),
...
(29,	'Anthony De La Cave',	100,	100,	100,	100,	100,	100,	NULL,	NULL,	NULL,	1,	9,	22,	NULL,	'a:2:{i:0;i:1;i:1;s:2:\"27\";}');
...
(15,	'Ration',	50,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	203,	1);
...
(203,	'ration',	'/tmp/php4aW1tr',	'images/ration.png');
...
(37,	'anthonyGM@gamemaster.com',	'[\"ROLE_PLAYER\", \"ROLE_GAMEMASTER\"]',	'$2y$13$JMkJCt3musbDWgcWADolTOepdXM7d9GY9zoQsVWCDYu50x5XkzXje',	'Game Master',	25),
