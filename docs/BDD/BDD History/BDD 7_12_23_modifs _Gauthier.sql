...
(8,	'Gauthier le roi des insoumis',	100,	97,	100,	100,	100,	101,	10,	NULL,	NULL,	1,	12,	26,	NULL,	'a:2:{i:0;i:1;i:1;s:1:\"5\";}'),
...
(2,	'Epée rudimentaire',	NULL,	3,	NULL,	NULL,	NULL,	NULL,	NULL,	190,	0),
(3,	'Bouclier rudimentaire',	NULL,	NULL,	NULL,	NULL,	3,	NULL,	NULL,	192,	0),
(4,	'Petite potion',	40,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL,	195,	1),
(5,	'Dague rudimentaire',	NULL,	NULL,	NULL,	3,	NULL,	NULL,	NULL,	191,	0),
(6,	'Rune simple',	NULL,	NULL,	3,	NULL,	NULL,	NULL,	NULL,	194,	0),
...
(4,	'Thorgar la Rôdeuse',	'Thorgar dégage une aura féroce et semble évaluer votre potentiel. De terribles loups aux yeux dorés l\'accompagnent. Ils se postent à ses côtés en vous observant.',	30,	100,	100,	104,	100,	100,	0,	1,	0,	1,	186,	30),
...
(6,	'Les Gobelins Artificiers',	'Le chef des Gobelins Artificiers se présente devant vous, c\'est un inventeur redoutable et déjanté, maîtrisant l\'art de la magie mécanique et de l\'alchimie déviante.',	20,	100,	105,	100,	100,	100,	0,	1,	200,	3,	171,	20),
(7,	'Le Dragon des Brumes',	'Il se dresse fièrement sur ses pattes griffues, ses ailes déployées, et pousse un hurlement déchirant qui fait vibrer vos os. Sa gueule ne crache pas du feu, mais un nuage de brume toxique.',	50,	100,	100,	100,	100,	100,	1,	1,	0,	14,	165,	50),
(8,	'La Gardienne des Ancêtres',	'Avec étonnement, vous constatez que le dernier grondement provient du ventre de la Gardienne des Ancêtres qui s\'avance vers vous.',	40,	100,	100,	105,	98,	100,	1,	1,	0,	11,	188,	40),
(9,	'La Sorcière de l\'humus',	'Elle s\'avance d\'un pas lent et majestueux, exsudant une aura de pouvoir corrompu. Son rire vous fait frissonner jusqu\'à la moelle.',	45,	100,	103,	100,	98,	100,	1,	1,	0,	7,	176,	45),
(10,	'Arachnus Maximus',	'L\'imposant arachnide émerge des ombres, le corps couvert de poils d\'un bleu-nuit poisseux. Ses pattes se terminent en griffes acérées.',	40,	100,	100,	102,	100,	100,	0,	1,	100,	10,	160,	40),
...
(18,	'Farcey Atrap, un Lutin Plaisantin',	'Farcey Atrap observe les miroirs avec amusement et applaudit, ravi de son effet ! Il a les gestes vifs et agiles d\'un prestidigitateur...',	30,	100,	104,	100,	100,	100,	0,	1,	NULL,	13,	169,	30),
(19,	'Griflamme l\'Impétueux',	'Un loup aux yeux perçants surgit des ténèbres. Son allure majestueuse dégage une aura effrayante et fascinante. Ses jappements rauques résonnent dans l\'air glacial.',	30,	102,	100,	100,	100,	100,	0,	1,	NULL,	10,	173,	30),
(20,	'Gobul, Reine des Sangsues',	'Une créature à la peau visqueuse sort lentement de l\'eau. Des sangsues géantes se tortillent sur son corps. Elle vous regarde avec un sourire malsain.',	50,	98,	98,	98,	100,	100,	0,	1,	NULL,	16,	172,	50),
(21,	'Ombrethorn, le Fantôme Sylvestre',	'Ombrethorn flotte dans les airs, son corps translucide se mêlant à la brume environnante. Autour de lui, des feux follets dansent mystérieusement.',	35,	100,	100,	100,	98,	100,	0,	1,	NULL,	11,	182,	35),
(22,	'Discordia la Dryade',	'Le sourire malicieux et le regard pétillant de Discordia trahissent sa nature facétieuse. Autour d\'elle, les animaux de la forêt semblent se divertir en reprenant les ragots qu\'elle colporte.',	30,	100,	102,	100,	100,	100,	0,	1,	NULL,	5,	164,	30),
(23,	'Jerarmajax, le Maître des Illusions',	'Les vêtements chatoyants du magicien reflètent la lueur astrale. Il semble capable de manipuler les étoiles elles-mêmes pour créer des mirages troublants.',	40,	100,	100,	100,	99,	100,	0,	1,	NULL,	11,	175,	40),
(24,	'Lilith, la Voleuse d\'Écho',	'Lilith apparaît, aérienne. Ses lèvres ne bougent pas et pourtant, autour d\'elle, des ombres mélodieuses semblent déverser des mots volés que vous peinez à comprendre.',	30,	100,	100,	102,	100,	100,	0,	1,	NULL,	11,	178,	30),
(25,	'Le Petit Chaperon Rouge-Sang',	'Elle est vêtue d\'une cape écarlate et son visage est dissimulé par le capuchon, dévoilant uniquement son regard surnaturel. Sa démarche est à la fois gracieuse et dérangeante, comme si la Grande Faucheuse elle-même avait pris forme dans ce personnage envoûtant. Ses doigts crochus se crispent sur l\'anse de son panier macabre.',	30,	100,	100,	100,	100,	100,	1,	1,	NULL,	16,	177,	30),
(26,	'Maître Corbeau',	'Soudain, un craquement retentit et le Maître Corbeau se révèle, son regard trahissant une intelligence maligne. Sa voix s\'élève, teintée d\'une ironie mordante, alors qu\'il se prépare à défendre son royaume de votre dérangeante présence.',	40,	100,	105,	104,	100,	100,	1,	1,	NULL,	10,	181,	40),
(27,	'Aria la Biche Blessée',	'La Biche Blessée avance vers vous en quelques bonds étranges, sa silhouette déformée par la souffrance et la rage. Ses yeux autrefois doux sont maintenant injectés de sang, et ses bois déchiquetés semblent prêts à transpercer quiconque ose s\'approcher. Des cicatrices béantes marquent son pelage délavé.',	50,	102,	100,	100,	99,	100,	1,	1,	NULL,	10,	161,	50);
