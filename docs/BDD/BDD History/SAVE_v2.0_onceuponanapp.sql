...
(7, 'Anthony de la Cave', 100, 70, 100, 150, 100, 100, 10, NULL, NULL, 1, 9, 22),
...
(1, 'Brom la Chasseuse  de Monstres', 'Brom lève sa main gantée vers le ciel et un éclair d\'énergie magique crépite dans sa paume. Les champignons se mettent à briller intensément. Elle se tourne vers vous avec un sourire malicieux.', 100, 100, 100, 100, 100, 100, 0, 0, 0, 1, 17, NULL),
(2, 'Eloi le Protecteur des Animaux', 'D\'un pas léger malgré sa carrure imposante, Éloi s\'approche de vous, accompagné d\'une ménagerie d\'animaux. Il tend les bras et un écureuil s\'y précipite alors qu\'il s\'adresse à vous.', 100, 100, 100, 100, 100, 100, 0, 0, 0, 1, 49, NULL),
(3, 'Lysandre l\'Érudite', 'Lysandre semble incarner la sagesse et la beauté des temps anciens. Elle s\'approche de vous avec grâce, ses pas résonnant doucement sur les dalles de pierre. Elle brûle de vous poser une question capitale.', 100, 100, 100, 100, 100, 100, 0, 0, 0, 2, 48, NULL),
(4, 'Thorgar la Rôdeuse', 'Thorgar dégage une aura féroce et semble évaluer votre potentiel. De terribles loups aux yeux dorés l\'accompagnent. Ils se postent à ses côtés en vous observant.', 100, 100, 100, 100, 100, 100, 0, 1, 0, 1, 47, NULL),
(5, 'Les Farfadets Chapardeurs', 'En baissant les yeux vous découvrez les Farfadets Chapardeurs, d\'étranges et espiègles créatures aux yeux malicieux.', 100, 100, 100, 100, 100, 100, 0, 1, 0, 8, 46, NULL),
(6, 'Les Gobelins Artificiers', 'Le chef des Gobelins Artificiers se présente devant vous, redoutable inventeur déjanté, maîtrisant l\'art de la magie mécanique et de l\'alchimie déviante.', 100, 100, 100, 100, 100, 100, 0, 1, 200, 3, 45, NULL),
(7, 'Le Dragon des Brumes', 'Il se dresse fièrement sur ses pattes griffues, ses ailes déployées, et pousse un hurlement déchirant qui fait vibrer vos os. Sa gueule ne crache pas du feu, mais un nuage de brume toxique.', 100, 100, 100, 100, 100, 100, 1, 1, 0, 14, 44, NULL),
(8, 'La Gardienne des Ancêtres', 'Avec étonnement, vous constatez que le dernier grondement provient du ventre de la Gardienne des Ancêtres qui s\'avance vers vous.', 100, 100, 100, 100, 100, 100, 1, 1, 0, 11, 43, NULL),
(9, 'La Sorcière de l\'humus', 'Elle s\'avance d\'un pas lent et majestueux, exsudant une aura de pouvoir corrompu. Son rire vous fait frissonner jusqu\'à la moelle.', 100, 100, 100, 100, 100, 100, 1, 1, 0, 7, 42, NULL),
(10, 'Arachnus Maximus', 'L\'imposant Arachnus Maximus émerge des ombres, le corps couvert de poils noirs et brillants. Ses pattes se terminent en griffes acérées.', 100, 100, 100, 100, 100, 100, 0, 1, 100, 10, 41, NULL),
(11, 'Elara la Prêtrese Sylvestre', 'Elara est une prêtresse douce et bienveillante, vêtue d\'une robe blanche ornée de feuilles et de fleurs. Ses yeux reflètent la sagesse des anciens esprits.', 100, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, 1, 91, NULL),
(12, 'Lumi le Petit Pêcheur', 'Lumi est un garçon vif et curieux au visage constellé de taches de rousseur. Il tient une canne à pêche miniature dans ses mains.', 100, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, 1, 99, NULL),
(13, 'Ivy, votre Sorcière Bien Aimée', 'La lumière provient de la main de cette petite sorcière. Elle est verte, tout comme sa peau claire et ses deux longues tresses.', 100, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, 7, 95, NULL),
(14, 'Bryn, le Chevalier Feuillu', 'Bryn est une force tranquille. Son armure végétale se fond si bien dans le paysage que vous avez failli le rater.', 100, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, 5, 89, NULL),
(15, 'Seraphina, la Dryade Astrale', 'Seraphina apparaît devant vous. Vous mettez la main en visière, légèrement ébloui.', 100, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, 5, 104, NULL),
(16, 'Pop-Cornes le Minotaure', 'Son corps massif et sa crinière touffue vous impressionnent. Il a l\'air affamé et les gargouillis de son ventre font vibrer la terre sous vos pieds.', 100, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, 16, 102, NULL),
(17, 'Remy le Barde', 'Au centre du groupe, vous repérez immédiatement le barde, sa guitare acoustique à la main. Il a des cheveux magnifiques et respire la confiance et la séduction.', 100, NULL, NULL, NULL, NULL, NULL, 0, 0, NULL, 1, 103, NULL),
(18, 'Farcey Atrap, un Lutin Plaisantin', 'Farcey Atrap observe les miroirs avec amusement et applaudit, ravi de son effet ! Il a les gestes vifs et agiles d\'un prestidigitateur...', 100, NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, 13, 92, NULL),
(19, 'Griflamme l\'Impétueux', 'Un loup aux yeux perçants surgit des ténèbres. Son allure majestueuse dégage une aura effrayante et fascinante. Sa voix rauque résonne dans l\'air glacial.', 100, NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, 1, 94, NULL),
(20, 'Gobul, Reine des Sangsues', 'Une créature à la peau visqueuse sort lentement de l\'eau. Des sangsues géantes se tortillent sur son corps. Elle vous regarde avec un sourire malsain.', 100, NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, 16, 93, NULL),
(21, 'Ombrethorn, le Fantôme Sylvestre', 'Ombrethorn flotte dans les airs, son corps translucide se mêlant à la brume environnante. Autour de lui, des feux follets dansent mystérieusement.', 100, NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, 11, 101, NULL),
(22, 'Discordia la Dryade', 'Le sourire malicieux et le regard pétillant de Discordia trahissent sa nature facétieuse. Autour d\'elle, les animaux de la forêt semblent se divertir en reprenant les ragots qu\'elle colporte.', 100, NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, 5, 90, NULL),
(23, 'Jerarmajax, le Maître des Illusions', 'Les vêtements chatoyants du magicien reflètent la lueur astrale. Il semble capable de manipuler les étoiles elles-mêmes pour créer des mirages troublants.', 100, NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, 1, 96, NULL),
(24, 'Lilith, la Voleuse d\'Écho', 'Lilith apparaît, aérienne. Ses lèvres ne bougent pas et pourtant, autour d\'elle, des ombres mélodieuses semblent déverser des mots volés que vous peinez à comprendre.', 100, NULL, NULL, NULL, NULL, NULL, 0, 1, NULL, 11, 98, NULL),
(25, 'Le Petit Chaperon Rouge-Sang', 'Elle est vêtue d\'une cape écarlate et son visage est dissimulé par le capuchon, dévoilant uniquement son regard surnaturel. Sa démarche est à la fois gracieuse et dérangeante, comme si la Grande Faucheuse elle-même avait pris forme dans ce personnage envoûtant. Ses doigts crochus se crispent sur l\'anse de son panier macabre.', 100, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, 11, 97, NULL),
(26, 'Maître Corbeau', 'Soudain, un craquement retentit et le Maître Corbeau se révèle, son regard trahissant une intelligence maligne. Sa voix s\'élève, teintée d\'une ironie mordante, alors qu\'il se prépare à défendre son royaume de votre dérangeante présence.', 100, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, 10, 100, NULL),
(27, 'Aria la Biche Blessée', 'La Biche Blessée avance vers vous en quelques bonds étranges, sa silhouette déformée par la souffrance et la rage. Ses yeux autrefois doux sont maintenant injectés de sang, et ses bois déchiquetés semblent prêts à transpercer quiconque ose s\'approcher. Des cicatrices béantes marquent son pelage délavé.', 100, NULL, NULL, NULL, NULL, NULL, 1, 1, NULL, 10, 88, NULL);
