...
CREATE TABLE `event` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_3BAE0AA7EE45BDBF` (`picture_id`),
  ...
  CONSTRAINT `FK_3BAE0AA7EE45BDBF` FOREIGN KEY (`picture_id`) REFERENCES `picture` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(14,	'Victoire !',	'Les terres enchantées se réjouissent de votre succès, tandis que votre nom résonne désormais comme une légende dans les tavernes et les foyers du royaume.',	'Congratulations',	7,	2,	29),
(18,	'Game Over',	'Vous n\'êtes pas prêt !',	'Vous êtes mort !',	8,	2,	28),
...
(20,	'La Branche Crochue',	'L\'air est empreint d\'une odeur d\'humus et de mystère, tandis que les murmures du vent résonnent parmi les feuilles froissées. Des corbeaux géants, leurs plumes noires luisant sinistrement, surveillent les environs depuis les branches tordues des arbres centenaires.',	'Derrière le bruit du vent, vous distinguez comme un croassement dissonant.',		5,	1, NULL),
(21,	'L\'Allée de l\'Absence Tourmentée',	'Vous avancez le long d\'une allée sombre et oppressante. Les arbres dénudés se dressent, tordus comme des griffes prêtes à attaquer. Une aura de douleur et de tristesse infinie émane de chaque recoin de ce lieu maudit et pénètre votre âme.',	'Une longue allée s\'ouvre sous vos pas.',	5,	1, NULL),
(22,	'Le champ de fleurs sauvages',	'Vous pénétrez dans un vaste champ où des fleurs aux couleurs éclatantes dansent au rythme d\'une brise légère. Le parfum envoûtant des fleurs embaume l\'air, créant une ambiance enchanteresse. Des papillons aux ailes chatoyantes voltigent joyeusement parmi les pétales, ajoutant une touche de magie à ce tableau floral.',	'Une brise légère apporte avec elle de délicieuses flagrances fleuries.',	2,	1, NULL),
(23,	'Le petit pont de bois',	'Un charmant petit pont de bois enjambant un ruisseau cristallin s\'étend devant vous. Son apparence rustique est agrémentée de délicates sculptures de créatures fantastiques. Les planches grincent légèrement sous vos pas, créant une mélodie discrète qui semble éveiller la nature environnante. C\'est un passage pittoresque qui invite à l\'aventure.',	'Vous prenez un sentier pittoresque, où court une jolie rivière.',	2,	1, NULL),
(24,	'La flaque aux reflets magiques',	'Vous découvrez une flaque d\'eau d\'apparence banale, mais ses reflets sont d\'une étrange beauté. Les rayons du soleil se jouent à sa surface, créant des tourbillons de couleurs chatoyantes qui semblent presque hypnotiques. Vous ne pouvez vous empêcher de vous pencher pour contempler ce spectacle fascinant, sentant l\'énergie magique émaner de cet humble point d\'eau.',	'Votre regard est captivé par une simple flaque d\'eau à vos pieds.',	2,	1, NULL),
(25,	'Le tronc du vieil arbre mort',	'Un imposant tronc d\'arbre gît au sol, témoignant des âges passés de la forêt. Malgré son apparence décrépite, des lianes grimpantes l\'enlacent avec grâce, formant un motif naturellement sculpté. Des champignons luminescents éclosent sur l\'écorce usée, diffusant une douce lueur dans l\'obscurité environnante. C\'est un lieu empreint de sérénité, où la vie trouve un moyen même dans la mort.',	'Vous avancez vers un imposant tronc d\'arbre couché au sol.',	2,	1, NULL),
(26,	'La Clairière Verdoyante',	'Une clairière baignée de lumière dorée se dévoile à travers les branches d\'arbres anciens. Des papillons multicolores virevoltent joyeusement. Une femme se tient debout, une aura apaisante émanant d\'elle.',	'Un papillon volette à vos côtés et vous entraîne.',	3,	1, NULL),
(27,	'La Rivière aux Poissons d\'Or',	'La rivière scintille, bordée de nénuphars aux pétales dorés. Les reflets du soleil dansent sur l\'eau calme. Vous distinguez un enfant près de la rive.',	'Vous entendez le bruit mélodieux d\'une petite rivière.',	3,	1, NULL),
(28,	'Les Arbres aux Sortilèges',	'Une clairière s\'ouvre devant vous, entourée d\'arbres sans feuilles. Une faible lueur verte vous rassure dans la pénombre.',	'Vous vous enfoncez encore dans la forêt, de plus en plus verte.',	3,	1, NULL),
(29,	'L\'Autel de l\'Écorce',	'Un autel en pierre se dresse, orné de motifs représentant des feuilles et des racines entremêlées. Quelqu\'un monte visiblement la garde pour le défendre.',	'Que voyez-vous là-bas ? On dirait un lieu de culte.',	3,	1, NULL),
(30,	'Le Chant des Étoiles',	'Cet endroit est illuminé par une lueur céleste. Les arbres scintillants vous font penser aux étoiles d\'un ciel nocturne.',	'La lumière décline pour mieux faire ressortir de vifs points lumineux.',	3,	1, NULL),
(31,	'Le Labyrinthe de Maïs',	'Vous arrivez devant une immense structure labyrinthique qu\'il va falloir traverser. Les hautes tiges dorées s\'étendent vers le ciel à perte de vue. Une créature imposante émerge des épis.',	'Vous distinguez comme un fort végétal qui se dresse, non loin.',	3,	1, NULL),
(32,	'Soirée Musicale au Feu Follet',	'Les rires qui résonnent sur fond de musique endiablée vous réchauffent l\'âme. L\'atmosphère est festive et chaleureuse. Au centre, mille Feux Follets composent un immense feu de joie.',	'Des accords de guitare vous parviennent. Vous courez pour voir qui joue si divinement bien.',	3,	1, NULL),
(33,	'Le Palais du Rire',	'Vous vous aventurez dans une grotte sombre, mais quelque chose attire immédiatement votre attention : chaque paroi est un miroir déformant. L\'atmosphère est déstabilisante et désopilante.',	'Quel est ce bruit ? On dirait une créature magique qui pouffe de rire.',	1,	1, NULL),
(34,	'Le Repaire du Loup Solitaire',	'Vous pénétrez dans une caverne sombre, à la lueur des flammes vacillantes. Une atmosphère de mystère et de danger vous entoure. Vous ressentez une présence féroce qui approche.',	'Vous reconnaissez un cri animal. Vous allez voir s\'il n\'est pas blessé.',	1,	1,	NULL),
(35,	'La Mare Gluante',	'Vous arrivez devant une étendue d\'eau sombre et stagnante, couverte d\'une épaisse couche de mousse. Des bulles inquiétantes émergent de la surface, dans un bruit de succion.',	'Vous remarquez une étrange odeur émanant des alentours.',	1,	1, NULL),
(36,	'Le Sentier Vacillant',	'Vous débouchez sur un sentier étroit et sinueux, perché au-dessus d\'un précipice abyssal. Une brume épaisse enveloppe le chemin. Soudain, une silhouette éthérée se matérialise devant vous.',	'Vous choisissez un chemin plus escarpé pour prendre un peu de hauteur.',	1,	1, NULL),
(37,	'Les Buissons des Ragots',	'Vous pénétrez dans une clairière ombragée, où les buissons frétillent d\'excitation. Des voix chuchotantes et rieuses s\'échappent des feuillages. Vous apercevez une silhouette gracile parmi les arbustes.',	'Des chuchotis émanent des buissons qui frémissent tout autour de vous.',	1,	1,	NULL),
(38,	'La Porte des Étoiles',	'Devant vous se dresse une imposante arche de pierre gravée de symboles célestes. Des constellations scintillantes se dessinent au-dessus, formant une porte éthérée vers l\'inconnu.',	'Une vision vous conseille une direction. Vous lui faites confiance.',	1,	1, NULL),
(39,	'Le Val de Perte-Voix',	'Vous arrivez dans un vallon encaissé, où les échos résonnent avec une étrange intensité. Vous criez et le vent emporte votre voix dans un tourbillon mélancolique. Une silhouette accourt, avide de vos paroles.',	'Vous descendez plus profondément dans la vallée. L\'acoustique est intense par ici.',	1,	1,	NULL);
...
CREATE TABLE `hero` (
  ...
  KEY `IDX_51CE6E86EE45BDBF` (`picture_id`),
  ...
  CONSTRAINT `FK_51CE6E86EE45BDBF` FOREIGN KEY (`picture_id`) REFERENCES `picture` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1,	'Sandra du Cookie Ploup-Ploup',	100,	100,	100,	150,	100,	100,	10,	0,	NULL,	1,	11,	24),
(2,	'Marine du Poney trop Stylé',	100,	100,	100,	150,	100,	100,	10,	0,	NULL,	1,	10,	23),
(6,	'Pierre de la Grotte carrelée',	100,	100,	100,	150,	100,	100,	10,	0,	NULL,	1,	8,	15),
(7,	'Anthony de la Cave',	100,	100,	100,	150,	100,	100,	10,	NULL,	NULL,	1,	9,	22),
(8,	'Gauthier le roi des insoumis',	100,	100,	100,	150,	100,	100,	10,	NULL,	NULL,	1,	12,	26),
(12,	'Testeur',	100,	100,	100,	100,	100,	100,	7,	0,	0,	2,	27,	18),
(13,	'Visiteur',	100,	100,	100,	100,	100,	100,	0,	0,	0,	2,	28,	11),
(14,	'Death',	1,	1,	1,	1,	1,	1,	4,	0,	0,	2,	29,	25);
...
CREATE TABLE `item` (
  ...
  `picture_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_1F1B251EEE45BDBF` (`picture_id`),
  CONSTRAINT `FK_1F1B251EEE45BDBF` FOREIGN KEY (`picture_id`) REFERENCES `picture` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `npc` (
  ...
  `picture_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_468C762CEE45BDBF` (`picture_id`),
  KEY `IDX_468C762C6E59D40D` (`race_id`),
  CONSTRAINT `FK_468C762C6E59D40D` FOREIGN KEY (`race_id`) REFERENCES `race` (`id`),
  CONSTRAINT `FK_468C762CEE45BDBF` FOREIGN KEY (`picture_id`) REFERENCES `picture` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(11,	'Elara la Prêtrese Sylvestre',	'Elara est une prêtresse douce et bienveillante, vêtue d\'une robe blanche ornée de feuilles et de fleurs. Ses yeux reflètent la sagesse des anciens esprits.',	100,	NULL,	NULL,	NULL,	NULL,	NULL,	0,	0,	NULL,	1, NULL),
(12,	'Lumi le Petit Pêcheur',	'Lumi est un garçon vif et curieux au visage constellé de taches de rousseur. Il tient une canne à pêche miniature dans ses mains.',	100,	NULL,	NULL,	NULL,	NULL,	NULL,		0,	0,	NULL,	1, NULL),
(13,	'Ivy, votre Sorcière Bien Aimée',	'La lumière provient de la main de cette petite sorcière. Elle est verte, tout comme sa peau claire et ses deux longues tresses.',	100,	NULL,	NULL,	NULL,	NULL,	NULL,	0,	0,	NULL,	7, NULL),
(14,	'Bryn, le Chevalier Feuillu',	'Bryn est une force tranquille. Son armure végétale se fond si bien dans le paysage que vous avez failli le rater.',	100,	NULL,	NULL,	NULL,	NULL,	NULL,		0,	0,	NULL,	5, NULL),
(15,	'Seraphina, la Dryade Astrale',	'Seraphina apparaît devant vous. Vous mettez la main en visière, légèrement ébloui.',	100,	NULL,	NULL,	NULL,	NULL,	NULL,		0,	0,	NULL,	5, NULL),
(16,	'Pop-Cornes le Minotaure',	'Son corps massif et sa crinière touffue vous impressionnent. Il a l\'air affamé et les gargouillis de son ventre font vibrer la terre sous vos pieds.',	100,	NULL,	NULL,	NULL,	NULL,	NULL,		0,	0,	NULL,	16, NULL),
(17,	'Remy le Barde',	'Au centre du groupe, vous repérez immédiatement le barde, sa guitare acoustique à la main. Il a des cheveux magnifiques et respire la confiance et la séduction.',	100,	NULL,	NULL,	NULL,	NULL,	NULL,		0,	0,	NULL,	1, NULL),
(18,	'Farcey Atrap, un Lutin Plaisantin',	'Farcey Atrap observe les miroirs avec amusement et applaudit, ravi de son effet ! Il a les gestes vifs et agiles d\'un prestidigitateur...',	100,	NULL,	NULL,	NULL,	NULL,	NULL,		0,	1,	NULL,	13, NULL),
(19,	'Griflamme l\'Impétueux',	'Un loup aux yeux perçants surgit des ténèbres. Son allure majestueuse dégage une aura effrayante et fascinante. Sa voix rauque résonne dans l\'air glacial.',	100,	NULL,	NULL,	NULL,	NULL,	NULL,	0,	1,	NULL,	1,	NULL),
(20,	'Gobul, Reine des Sangsues',	'Une créature à la peau visqueuse sort lentement de l\'eau. Des sangsues géantes se tortillent sur son corps. Elle vous regarde avec un sourire malsain.',	100,	NULL,	NULL,	NULL,	NULL,	NULL,	0,	1,	NULL,	16,	NULL),
(21,	'Ombrethorn, le Fantôme Sylvestre',	'Ombrethorn flotte dans les airs, son corps translucide se mêlant à la brume environnante. Autour de lui, des feux follets dansent mystérieusement.',	100,	NULL,	NULL,	NULL,	NULL,	NULL,	0,	1,	NULL,	11,	NULL),
(22,	'Discordia la Dryade',	'Le sourire malicieux et le regard pétillant de Discordia trahissent sa nature facétieuse. Autour d\'elle, les animaux de la forêt semblent se divertir en reprenant les ragots qu\'elle colporte.',	100,	NULL,	NULL,	NULL,	NULL,	NULL,	0,	1,	NULL,	5,	NULL),
(23,	'Jerarmajax, le Maître des Illusions',	'Les vêtements chatoyants du magicien reflètent la lueur astrale. Il semble capable de manipuler les étoiles elles-mêmes pour créer des mirages troublants.',	100,	NULL,	NULL,	NULL,	NULL,	NULL,	0,	1,	NULL,	1,	NULL),
(24,	'Lilith, la Voleuse d\'Écho',	'Lilith apparaît, aérienne. Ses lèvres ne bougent pas et pourtant, autour d\'elle, des ombres mélodieuses semblent déverser des mots volés que vous peinez à comprendre.',	100,	NULL,	NULL,	NULL,	NULL,	NULL,	0,	1,	NULL,	11,	NULL),
(25,	'Le Petit Chaperon Rouge-Sang',	'Elle est vêtue d\'une cape écarlate et son visage est dissimulé par le capuchon, dévoilant uniquement son regard surnaturel. Sa démarche est à la fois gracieuse et dérangeante, comme si la Grande Faucheuse elle-même avait pris forme dans ce personnage envoûtant. Ses doigts crochus se crispent sur l\'anse de son panier macabre.',	100,	NULL,	NULL,	NULL,	NULL,	NULL,	1,	1,	NULL,	11,	NULL),
(26,	'Maître Corbeau',	'Soudain, un craquement retentit et le Maître Corbeau se révèle, son regard trahissant une intelligence maligne. Sa voix s\'élève, teintée d\'une ironie mordante, alors qu\'il se prépare à défendre son royaume de votre dérangeante présence.',	100,	NULL,	NULL,	NULL,	NULL,	NULL,	1,	1,	NULL,	10,	NULL),
(27,	'Aria la Biche Blessée',	'La Biche Blessée avance vers vous en quelques bonds étranges, sa silhouette déformée par la souffrance et la rage. Ses yeux autrefois doux sont maintenant injectés de sang, et ses bois déchiquetés semblent prêts à transpercer quiconque ose s\'approcher. Des cicatrices béantes marquent son pelage délavé.',	100,	NULL,	NULL,	NULL,	NULL,	NULL,	1,	1,	NULL,	10,	NULL);
...
CREATE TABLE `picture` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UNIQ_16DB4F895E237E06` (`name`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(24,	'Sandra Avatar',	'/tmp/phpf7tEXW',	'images/cartoon-cookie-icon-png.webp'),
...
CREATE TABLE `user` (
  ...
  CONSTRAINT `FK_8D93D64986383B10` FOREIGN KEY (`avatar_id`) REFERENCES `picture` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

INSERT INTO `user` (`id`, `email`, `roles`, `password`, `pseudo`, `avatar_id`) VALUES
(8,	'pierre@admin.com',	'[\"ROLE_ADMIN\"]',	'$2y$13$h5/TrGHUNtiCzOSAVmfV..0KJllcpnPiB90XzVq0z86jPuehUQq0m',	'Pierre',	12),
(9,	'anthony@admin.com',	'[\"ROLE_ADMIN\"]',	'$2y$13$h5/TrGHUNtiCzOSAVmfV..0KJllcpnPiB90XzVq0z86jPuehUQq0m',	'Anthony',	22),
(10,	'marine@gameMaster.com',	'[\"ROLE_GAMEMASTER\"]',	'$2y$13$LMDD1/gH0ONyuexKiVsxxu52Yx5p5q98qmmTOBgh11PcdXzUt4pf6',	'Marine',	23),
(11,	'sandra@gameMaster.com',	'[\"ROLE_GAMEMASTER\"]',	'$2y$13$LMDD1/gH0ONyuexKiVsxxu52Yx5p5q98qmmTOBgh11PcdXzUt4pf6',	'Sandra',	24),
(12,	'gauthier@gameMaster.com',	'[\"ROLE_GAMEMASTER\"]',	'$2y$13$LMDD1/gH0ONyuexKiVsxxu52Yx5p5q98qmmTOBgh11PcdXzUt4pf6',	'Gauthier',	26),
...
(29,	'death@death.com',	'[\"ROLE_PLAYER\"]',	'$2y$13$GHnjN6QvKEJPiJPIk0Wjc.6bVRG2bQ2KiXVrlKp4LvCsJQxBtFpLm',	'Death',	25);
