...
(1,	'Même pas peur !',	1),
(2,	'Vous dégommez la grenade tel une balle de baseball !',	1),
(3,	'Avec ou sans sauce ?!',	2),
(4,	'La mèche ne prend visiblement pas',	2),
(5,	'Ca va bien ?',	3),
(6,	'Laisse moi tranquille !',	3);
...
(1,	'Bonus de Vie',	'Soin',	1,	NULL,	NULL,	NULL,	NULL,	NULL,	NULL),
...
(6,	'Les Gobelins Artificiers',	'Ces gobelins aiment jouer avec des explosifs et sont parfois aussi dangereux pour eux-mêmes que pour les autres.',	100,	100,	100,	100,	100,	100,	'https://cdn.midjourney.com/eba73e8c-3ccb-4bc7-8972-ee1fa133d86b/0_1.png',	0,	1,	200,	3),
